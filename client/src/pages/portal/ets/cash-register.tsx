    ...
    <div className="p-4 md:p-6 space-y-5 max-w-[1200px] mx-auto">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold" data-testid="text-register-title">Cash Register</h1>
            <p className="text-xs text-muted-foreground">Daily cash cycle management</p>
          </div>
        </div>
