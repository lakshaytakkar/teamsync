    ...
    categories: [
      {
        ...
        subcategories: [
          { id: "pans-woks", name: "Pans & Woks" },
          { id: "tools-spatulas", name: "Tools & Spatulas" },
          { id: "choppers-graters", name: "Choppers & Graters" },
        ],
      },
      {
        id: "storage-org",
        ...
        subcategories: [
          { id: "containers-boxes", name: "Containers & Boxes" },
          { id: "racks-shelves", name: "Racks & Shelves" },
          { id: "bags-wraps", name: "Bags & Wraps" },
        ],
      },
      {
        id: "dining",
        ...
        subcategories: [
          { id: "tiffin-bottles", name: "Tiffin & Bottles" },
    ...
    categories: [
      {
        ...
        name: "Skincare",
        subcategories: [
          { id: "face-wash-cream", name: "Face Wash & Cream" },
          { id: "moisturisers", name: "Moisturisers" },
        ],
      },
      {
        id: "haircare",
        name: "Haircare",
        subcategories: [
          { id: "combs-brushes", name: "Combs & Brushes" },
      ...
      },
      {
        ...
        name: "Bath & Body",
        subcategories: [
          { id: "soap-shower", name: "Soap & Shower" },
          { id: "loofahs-scrubs", name: "Loofahs & Scrubs" },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        ...
        name: "Writing Tools",
        subcategories: [
          { id: "pens-markers", name: "Pens & Markers" },
          { id: "pencils-erasers", name: "Pencils & Erasers" },
        ],
      },
      {
        id: "office-supplies",
        ...
        subcategories: [
          { id: "notebooks-pads", name: "Notebooks & Pads" },
          { id: "desk-organisers", name: "Desk Organisers" },
          { id: "sticky-notes", name: "Sticky Notes & Labels" },
        ],
      },
      {
        id: "art-craft",
        name: "Art & Craft",
        subcategories: [
          { id: "colour-paint", name: "Colour & Paint" },
    ...
    categories: [
      {
        ...
        name: "Wall Art",
        subcategories: [
          { id: "frames-posters", name: "Frames & Posters" },
          { id: "macrame-hangings", name: "Macramé & Hangings" },
        ],
      },
      {
        id: "indoor-decor",
        name: "Indoor Decor",
        subcategories: [
          { id: "planters-pots", name: "Planters & Pots" },
          { id: "candles-diffusers", name: "Candles & Diffusers" },
      ...
      },
      {
        ...
        name: "Lighting",
        subcategories: [
          { id: "led-lights", name: "LED Lights & Strips" },
    ...
    categories: [
      {
        ...
        name: "Travel Bags",
        subcategories: [
          { id: "duffel-trolley", name: "Duffel & Trolley" },
      ...
      },
      {
        ...
        name: "Everyday Bags",
        subcategories: [
          { id: "tote-shoulder", name: "Tote & Shoulder" },
          { id: "pouches-wallets", name: "Pouches & Wallets" },
        ],
      },
      {
        ...
        subcategories: [
          { id: "underbed-boxes", name: "Under-Bed Boxes" },
          { id: "laundry-baskets", name: "Laundry Baskets" },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        ...
        subcategories: [
          ...
          { id: "drawing-boards", name: "Drawing Boards" },
          { id: "outdoor-play", name: "Outdoor Play" },
        ],
      },
      {
        id: "fidgets-stress",
        name: "Fidgets & Stress",
        subcategories: [
          { id: "fidget-cubes", name: "Fidget Cubes & Spinners" },
          { id: "squeeze-balls", name: "Squeeze Balls" },
        ],
      },
      {
        id: "educational",
        name: "Educational",
        subcategories: [
          { id: "stem-kits", name: "STEM Kits" },
          { id: "flashcards", name: "Flashcards & Learning" },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        ...
        subcategories: [
          ...
          { id: "gift-boxes", name: "Gift Boxes & Wrapping" },
        ],
      },
      {
        id: "seasonal",
        name: "Seasonal",
        subcategories: [
          { id: "festive-diwali", name: "Festive & Diwali" },
      ...
      },
      {
        ...
        name: "Novelty & Fun",
        subcategories: [
          { id: "gadgets-novelty", name: "Gadget Novelty" },
          { id: "funny-gifts", name: "Funny & Quirky" },
        ],
      },
    ],
  },
